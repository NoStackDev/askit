      ...
      >
        <div className="flex flex-col gap-6 md:grid md:grid-cols-2 2xl:grid-cols-3 md:gap-x-5 gap-y-6">
          {requestsConfig.map((requestConfig) => {
            return (
              <Link
                href={`/requests/${requestConfig.id}`}
        ...
        <div className="flex mt-4 md:mt-6 gap-3">
          <div className="px-2 py-[5px] border-[1px] border-secondary text-title_3 font-body font-medium bg-secondary text-white hover:cursor-pointer">
            1
          </div>
          <div className="px-2 py-[5px] border-[1px] border-secondary text-title_3 font-body font-medium hover:cursor-pointer">
            2
          </div>
          <div className="px-2 py-[5px] border-[1px] border-secondary text-title_3 font-body font-medium hover:cursor-pointer">
            3
          ...
          <div className="px-2 py-[5px] border-[1px] border-secondary text-title_3 font-body font-medium hover:cursor-pointer md:ml-6">
            100
          </div>
          <div className="px-2 py-[5px] border-[1px] border-secondary text-title_3 font-body font-medium hover:cursor-pointer">
            101
